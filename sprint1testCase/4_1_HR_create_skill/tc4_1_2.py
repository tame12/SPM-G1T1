...
def tc4_1_2(i, driver, wait, skill_name):
...
def manytc4_1_2(n = 1):
  ...
  test_name = info['tc4_1_2']['name']
  test_desc = info["tc4_1_2"]['description']
  skill_name = info["tc4_1_2"]["skill_name"]

  url = info["tc4_1_2"]["url"]
  ...
  for i in range(1,n+1):
    ...
    try:
      tc4_1_2(i, driver, wait, skill_name)
