...
def tc4_1_4(i, driver, wait, skill_name):
...
def manytc4_1_4(n = 1):
  ...
  test_name = info['tc4_1_4']['name']
  test_desc = info["tc4_1_4"]['description']
  skill_name = info["tc4_1_4"]["skill_name"]

  url = info["tc4_1_4"]["url"]
  ...
  for i in range(1,n+1):
    ...
    try:
      tc4_1_4(i, driver, wait, skill_name)
