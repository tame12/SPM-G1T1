...
def tc4_3_4(i, driver, wait, skill_name):
  ...
  #red box with text "Skill name too long (max 50 characters)."
...
def manytc4_3_4(n = 1):
  ...
  test_name = info['tc4_3_4']['name']
  test_desc = info["tc4_3_4"]['description']
  skill_name = info["tc4_3_4"]["skill_name"]

  url = info["tc4_3_4"]["url"]
  ...
  for i in range(1,n+1):
    ...
    try:
      tc4_3_4(i, driver, wait, skill_name)
