...
def tc4_4_1(i, driver, wait, skills):
  ...
  logging.info('verified skill is active')
  ...
  logging.info('verified skill has been disabled') 
...
def manytc4_4_1(n = 1):
  ...
  test_name = info['tc4_4_1']['name']
  test_desc = info["tc4_4_1"]['description']
  skills = info["tc4_4_1"]["skills"]

  url = info["tc4_4_1"]["url"]
