...
def tc4_5_1(i, driver, wait, skills):
  ...
  logging.info('verified skill is disabled')
  ...
  logging.info('verified skill has been activated') 
...
def manytc4_5_1(n = 1):
  ...
  test_name = info['tc4_5_1']['name']
  test_desc = info["tc4_5_1"]['description']
  skills = info["tc4_5_1"]["skills"]

  url = info["tc4_5_1"]["url"]
