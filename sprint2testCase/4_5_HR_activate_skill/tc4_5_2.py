...
def tc4_5_2(i, driver, wait, skills):
  ...
  logging.info('verified skill is activated; unable to find activate skill button')
...
def manytc4_5_2(n = 1):
  ...
  test_name = info['tc4_5_2']['name']
  test_desc = info["tc4_5_2"]['description']
  skills = info["tc4_5_2"]["skills"]

  url = info["tc4_5_2"]["url"]
